...
\begin{itemize}
    \item Moira McDermott: LunarLander environment, policy, training, and reward implementation
    \item Himanshu Ranjan: Gridworld environment, policy, training implementation; SAE and classifier implementation
    \item Mayank: Gridworld environment and reward implementation; transfer evaluation; interpretability analysis
\end{itemize}
